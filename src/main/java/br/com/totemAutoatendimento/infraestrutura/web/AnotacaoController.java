...
public class AnotacaoController {
	...
	public ResponseEntity<Anotacao> criarAnotacao(@Valid @RequestBody DadosCriarOuEditarAnotacao dados) {
	...
	public ResponseEntity<DadosDeAnotacao> editarAnotacao(@PathVariable Long id, @RequestBody DadosCriarOuEditarAnotacao dados) {
	...
	@GetMapping(value = "/data-inicial/{dataInicial}/data-final/{dataFinal}")
	@Operation(summary = "Buscar anotações pela data", description = "Busca anotações por uma data inicial e uma data final")
	public ResponseEntity<Page<DadosDeAnotacao>> buscarAnotacoesPelaData(Pageable paginacao, @PathVariable LocalDate dataInicial, @PathVariable LocalDate dataFinal) {
